...
export const FeatureShowcase = ({
  ...
  return (
    <>
      ...
      <section
        className={cn(isDark ? "bg-[#001E2B] py-1 pb-20" : "bg-[#F9FAFB] py-1  pb-20")}
      >
        <div className="flex mx-auto px-20">
          <main className="flex-1">
            <div className="flex gap-12 items-center">
              {/* Left Nav */}
              <nav aria-label="use-cases nav" className="hidden lg:block lg:w-[250px] shrink-0">
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-16 items-center">
                    ...
                    <div className="flex flex-col justify-center">
                      <h2
                        className={cn(
                          "text-3xl md:text-2xl font-semibold mb-4",
                          isDark ? "text-white" : "text-[#0E1116]",
                        )}
                      >
                      ...
                      <p
                        className={cn(
                          "max-w-xl text-md leading-relaxed mb-8",
                          isDark ? "text-[#D1D5DB]" : "text-[#3A4048]",
                        )}
                      >
                      ...
                      <div className="flex items-center gap-8">
                        ...
                        >
                          ...
                          <svg
                            ...
                            aria-hidden
                            className={cn(
                              isDark ? "stroke-[#00ED64]" : "stroke-[#0B3C5D]",
                            )}
                          >
                            <path
                              d="M5 12h14"
