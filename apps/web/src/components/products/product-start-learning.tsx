      ...
      */}
      <div
        className={cn(
          ...
          " lg:rounded-r-[150px]",
          "py-16 md:py-[6rem]", // Generous vertical padding
          isDark
        ...
        >
          ...
          >
            ...
            <img
              ...
              alt=""
              role="presentation"
              className="relative z-10 w-full max-w-[60rem] object-contain px-4 sm:px-0"
            />
          </div>
          ...
          */}
          <div className="order-first lg:order-last flex flex-col justify-center">
            ...
            <p
              className={cn(
                "mt-6 text-xl max-w-prose leading-relaxed",
                isDark ? "text-[#93A6B3]" : "text-[#5F6C7B]", // text-300 : text-600
              )}
            >
              Master MongoDB Atlas quickly with guided webinars, interactive
              courses, skill badges, and comprehensive documentation—all
              designed to simplify your onboarding and accelerate success. Start
              building with confidence, faster.
            </p>
